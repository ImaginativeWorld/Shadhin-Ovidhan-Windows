...
{ *******************************************************
  ...
  Bangla (Bangladesh) Calendar Unit
...
begin
  ...
  TempBnFullDate := inttostr(StrDay) + ' ' + StrMonth + ' ' + inttostr(StrYear)
    + #10 + StrWeek;

  BnFullDate := ReplaceText
    (ReplaceText(ReplaceText(ReplaceText(ReplaceText(ReplaceText(ReplaceText
                (ReplaceText(ReplaceText(ReplaceText(TempBnFullDate, //
                      '1', '১'), //
                    '2', '২'), //
                  '3', '৩'), //
                '4', '৪'), //
  ...
  // EnFullDate := inttostr(DayOf(calendar.Date))
  // + ' ' + StrEnMonth + ' ' + StrWeek;
end;
